...
##############短期活动##############
#女装盲盒 活动时间：2021-05-24到2022-02-28
...
#东东农场助力
5 1 * * * node /scripts/jd_fruit_help.js >> /scripts/logs/jd_fruit_help.log 2>&1
#宠汪汪
...
#签到领现金
10 */8 * * * node /scripts/jd_cash.js >> /scripts/logs/jd_cash.log 2>&1
#京东秒秒币
...
#京东极速版签到+赚现金任务
21 1,12 * * * node /scripts/jd_speed_sign.js >> /scripts/logs/jd_speed_sign.log 2>&1
#京喜财富岛
