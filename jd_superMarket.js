...
!(async () => {
  ...
  $.fingerprint = 7548691553119222 || await generateFp();
  $.token = '';
  await requestAlgo();
...
async function getH5stBody(functionId, bodyInfo) {
  ...
  let url = `https://api.m.jd.com?appid=jdsupermarket&functionId=${functionId}&body=${bodySign}&client=m&clientVersion=10.2.4&t=${signtime}`;
