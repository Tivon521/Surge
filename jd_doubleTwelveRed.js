/*
京东12.12暖暖红包，每日可中奖1次！
领取地址：https://u.jd.com/nw5Iy2i
可复制上面链接用京粉APP转链后，取【https://u.jd.com/】后面的替换
环境变量：hbCode
0 0,12,22 * * * jd_doubleTwelveRed.js
*/
const $ = new Env('京东12.12暖暖红包');
...
function getCoupons() {
  return new Promise(resolve => {
    let opts = {
      url: `https://api.m.jd.com/api?functionId=getUnionFreeCoupon&appid=u&loginType=2&_=${+ new Date()}&body={%22couponUrl%22:%22RhdnEUlBFEc8FBpAEUBoRUsaFBBrRR5BQhBtQhMRFhBpERtHFkA4FgYbHBNnHwYRCB1mEBMa%22,%22source%22:20118}`,
      headers: {
