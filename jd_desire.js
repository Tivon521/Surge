            ...
            if (data.result && data['result']['code'] === 0 ) {
              if (data.result.taskPoolInfo && data.result.taskPoolInfo.taskList) {
                ...
                for (let vo of data.result.taskPoolInfo.taskList) {
                  ...
                  if (vo.taskId === 2004) {
                    const skuIds = ["2801602045","2801601938","2801602874","100020913338","10036827144553","100017366689","100004443975","100027604000","100028767808","100013996495","10025690385788","100008602877","100021106460","100023781630","100015224661","100021033900","10042146217596","100008764851","100021167332","100014536933","20341876908","100004585678","10039990473521","100010927583","7261582","100019557078","100016847561","100014564623","100022312122","10041715695543","100007325791","100010539015"]
                    for (const skuId of skuIds) {
                      console.log(`\n去完成 【${vo.taskName}】 任务，taskId：${vo.taskId}，skuIds：${skuId}`);
